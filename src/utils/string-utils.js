 ...
 */
StringUtils.prepareKeyword = function(keywords)
{
 ...
 */
StringUtils.splitKeywords = function(searchText)
{
 ...
 */
StringUtils.searchObject = function(searchText, object, attributes)
{
 ...
 * @return True if the two strings match, false otherwise.
 */
StringUtils.search = function(searchText, text)
{
